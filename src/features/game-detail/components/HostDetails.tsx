  ...
  return (
    <div className="space-y-4 hidden md:block">
      ...
      <div className="flex items-center gap-3">
        {/* <Avatar size="xs" /> */}
        <img src={gameDetailData?.host.profile_image_url} alt="host avatar" className="h-8 w-8 rounded-full" />
        <div className="flex flex-col gap-1 text-sm ">
          ...
          <div className="space-x-2 font-[400] text-white flex items-center ">
            <img src={getStarRating(gameDetailData?.host.host_rating.num_of_reviews)} alt="five_stars" />
