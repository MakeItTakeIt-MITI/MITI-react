        ...
        <ul className="flex gap-4 text-[#707070] text-xs font-bold">
          {INITIAL_DATES.map((date: InitialDateField) => {
            ...
            return (
              <li
                key={dateString}
                className={`flex flex-col items-center justify-center gap-2 w-[32px] cursor-pointer `}
              ...
              >
                <span
                  ...
                  // className={`${
                  //   isSelected ? "bg-[#1ADCDF] text-white rounded-full" : ""
                  // }`}
                >
                  {date.dayKorean}
                </span>
                <span
                  className={`${
                    isSelected ? "  text-[#1ADCDF] rounded-full" : ""
                  }`}
                >
                  {date.date}
                </span>
